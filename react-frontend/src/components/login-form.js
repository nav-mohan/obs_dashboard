        ...
        const loginFunction = (e) => {
            ...
            .then((resJson)=>{
                ...
                if(resJson.success == true){
                    ...
                    setIsLoading(false);
                    if(resJson.jwt){setToken(resJson.jwt);}
                    if(resJson.userLogin){setUserLogin(resJson.userLogin);}
                    if(resJson.userPass){setUserHashPass(resJson.userPass);}
                }
                else{
                    setIsLoading(false);
